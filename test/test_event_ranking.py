...
from net.thefletcher.tbaapi.v3client.models.event_ranking import EventRanking  # noqa: E501
...
class TestEventRanking(unittest.TestCase):
    ...
    def testEventRanking(self):
        ...
        # model = net.thefletcher.tbaapi.v3client.models.event_ranking.EventRanking()  # noqa: E501
        pass
