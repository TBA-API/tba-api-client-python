...
from net.thefletcher.tbaapi.v3client.models.team_event_status_alliance_backup import TeamEventStatusAllianceBackup  # noqa: E501
...
class TestTeamEventStatusAllianceBackup(unittest.TestCase):
    ...
    def testTeamEventStatusAllianceBackup(self):
        ...
        # model = net.thefletcher.tbaapi.v3client.models.team_event_status_alliance_backup.TeamEventStatusAllianceBackup()  # noqa: E501
        pass
