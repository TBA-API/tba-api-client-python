...
from net.thefletcher.tbaapi.v3client.models.match_alliance import MatchAlliance  # noqa: E501
...
class TestMatchAlliance(unittest.TestCase):
    ...
    def testMatchAlliance(self):
        ...
        # model = net.thefletcher.tbaapi.v3client.models.match_alliance.MatchAlliance()  # noqa: E501
        pass
