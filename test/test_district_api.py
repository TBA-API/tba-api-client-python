...
from net.thefletcher.tbaapi.v3client.api.district_api import DistrictApi  # noqa: E501
...
class TestDistrictApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = net.thefletcher.tbaapi.v3client.api.district_api.DistrictApi()  # noqa: E501
