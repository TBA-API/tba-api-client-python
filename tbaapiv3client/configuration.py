...
class Configuration(object):
    ...
    :param signing_info: Configuration parameters for HTTP signature.
        Must be an instance of tbaapiv3client.signing.HttpSigningConfiguration
    ...
    You can programmatically set the cookie:
      conf = tbaapiv3client.Configuration(
    ...
    Note you can use the constants defined in the tbaapiv3client.signing module, and you can
    ...
    are not going to be modified in transit.
      ...
      conf = tbaapiv3client.Configuration(
        signing_info = tbaapiv3client.signing.HttpSigningConfiguration(
            key_id =                 'my-key-id',
    ...
    def auth_settings(self):
        ...
        """
        auth = {}
        if 'X-TBA-Auth-Key' in self.api_key:
            auth['apiKey'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'X-TBA-Auth-Key',
